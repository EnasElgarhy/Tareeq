    ...
    <>
      ...
      <PageHeader
        ...
        actions={
          <>
            <Link
              href={`/admin/content/${version.id}/translations`}
              className="rounded-adm-md border border-adm-line px-3 py-1.5 text-[13px] font-semibold text-adm-ink-soft transition hover:bg-adm-sand hover:text-adm-ink"
            >
              Translations
            </Link>
